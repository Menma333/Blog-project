  ...
  return (
    <div className="container">
      ...
      <button
        ...
        onClick={() =>
          onOpenShowFullItem(
            `Angular is a popular open source framework for developing powerful web applications. Developed and maintained by the Google team, Angular offers developers a convenient and efficient toolkit for building modern and complex web applications.
      ...
      <button
        ...
        onClick={() =>
          onOpenShowFullItem(
            `Vue.js is a progressive framework for developing user interfaces and single-page web applications (SPAs) in JavaScript. It is designed to be lightweight and easy to use, while maintaining high performance and extensibility.
