...
const Home = ({ articles }) => {
  ...
  const items = [
    {
      title: "React",
      info: `React is one of the most popular and popular JavaScript libraries for
    ...
    {
      title: "Angular",
      info: `Angular is a popular open source framework for developing powerful web applications. Developed and maintained by the Google team, Angular offers developers a convenient and efficient toolkit for building modern and complex web applications.
    ...
    {
      title: "Vue.js",
      info: `Vue.js is a progressive framework for developing user interfaces and single-page web applications (SPAs) in JavaScript. It is designed to be lightweight and easy to use, while maintaining high performance and extensibility.
  ...
  return (
    <>
      <Slider />
      <InfoBlock onOpenShowFullItem={handleOpenShowFullItem} items={items} />
      <ArticleBlock
        articles={articles}
