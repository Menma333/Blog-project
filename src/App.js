      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/category" element={<Category articles={articles} />}>
            <Route path="react" element={<ReactPage articles={articles} />} />
            <Route path="angular" element={<AngularPage articles={articles} />} />
            <Route path="vue" element={<VuePage articles={articles} />} />
          </Route>
